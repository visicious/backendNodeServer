...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-03-2020 a las 18:21:47
...
(3, 'Andres ', 'Juarez Jimenez', 'H', NULL, NULL, NULL, NULL, 0, 'perdido', NULL, '', '', '2020-02-17 10:35:24', 'Urb Manzana Roja, Calle Tobaco 13', 'www.gestion.pe'),
...
(10, 'Joel', 'Valdez', 'H', NULL, NULL, NULL, NULL, 0, 'cliente', NULL, '', '', '2020-02-17 14:03:01', '', NULL),
...
(62, 4, 49, NULL, 'correo', '2020-03-19 13:33:53', '2020-03-19 13:33:53', NULL, 0, 'Con el asunto: Compre ahora ,se envío el siguiente correo: Bienvenido al familia Fuxion', 0);
...
CREATE TABLE `metas` (
  ...
  `avance` varchar(150) NOT NULL,
  `horaFechaCreacion` datetime NOT NULL,
  `horaFechaInicio` datetime DEFAULT NULL,
  `horaFechaTermino` datetime DEFAULT NULL,
  `eliminar` tinyint(1) NOT NULL
...
INSERT INTO `metas` (`id`, `idUsuario`, `nombre`, `valor`, `avance`, `horaFechaCreacion`, `horaFechaInicio`, `horaFechaTermino`, `eliminar`) VALUES
(1, 4, 'Obtener más de 2000 clientes', '2000', '15', '2020-03-16 11:33:18', NULL, NULL, 0),
(2, 1, 'Alcanzar a mis compañeros con el columen estandar de ventas', '15000', '', '2020-03-26 09:43:13', NULL, NULL, 0);
...
(21, 3, 0.1, 5, '2020-02-17 10:35:24', NULL, 'perdido', NULL, 17),
...
(25, 10, 0, 5, '2020-02-17 14:03:01', '2020-03-03 00:00:00', 'ganado', NULL, 13),
